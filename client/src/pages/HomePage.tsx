      ...
      <main>
        ...
        <section className="lx-intro lx-wrap">
          ...
          <div className="lx-facts">
            <div><strong>30+</strong><span>Years of founder’s industry experience</span></div>
            <div><strong>2017</strong><span>The beginning of Pan Eventz</span></div>
        ...
        <section className="lx-services lx-wrap">
          ...
          <div className="lx-service-list">
            {eventServices.map((service,i)=>(
              <Link href={'/services/'+service.slug} key={service.slug} className="lx-service-row">
